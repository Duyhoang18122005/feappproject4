  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Chính Sách', style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold)),
        centerTitle: true,
        leading: IconButton(
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: const [
                            Text('Liên hệ', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            SizedBox(height: 4),
                            Text('Email: support@gamehire.vn', style: TextStyle(color: Colors.white, fontSize: 13)),
                            Text('Hotline: 1900 1234 56', style: TextStyle(color: Colors.white, fontSize: 13)),
                          ],
                        ),
                      ),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text('Theo dõi chúng tôi', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                            const SizedBox(height: 4),
                            Row(
                              children: [
                                _FooterIcon(icon: Icons.facebook, url: '#'),
                                _FooterIcon(icon: Icons.camera_alt, url: '#'),
                                _FooterIcon(icon: Icons.alternate_email, url: '#'),
                                _FooterIcon(icon: Icons.ondemand_video, url: '#'),
                              ],
                            ),
                          ],
                        ),
                  ...
                  const SizedBox(height: 4),
                  const Text('© 2025 GameHire. Tất cả quyền được bảo lưu.', style: TextStyle(color: Color(0xFFB3BCF5), fontSize: 12)),
                ],
              ),
            ),
          ),
